...
async function cleanAndUploadCsvOnly() {
  console.log('=== CSV 파일 데이터만으로 테이블 정리 ===');
  ...
  console.log(`총 ${csvData.length}개의 CSV 데이터를 찾았습니다.`);
