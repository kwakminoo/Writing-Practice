...
const files = [
  'Scenario_Dialogue_Practice__All_1_000_-_UTF8_.csv',
  'Scenario_Ending_Rewrite_Practice__All_1_000_-_Fixed_UTF8_ (1).csv',
  'Scenario_Ending_Rewrite_Practice__All_1_000_-_Fixed_UTF8_.csv',
  'Scenario_Genre_Conversion_Practice__All_1_000_-_Fixed_UTF8_.csv',
  'Scenario_Improv_Practice__All_1_000_-_Fixed_UTF8_.csv',
  'Scenario_Roleplay_All__1_000_-_Fixed_with_id_.csv',
  'Scenario_Structure_Practice__All_1_000_-_Fixed_UTF8_.csv',
  'Scenario_Transition_Practice__All_1_000_-_UTF8_.csv'
];
...
async function uploadFile(filename) {
  ...
  try {
    ...
    const processedRecords = records.map((row, index) => {
      ...
      return {
        category: dataWithoutId.category || '시나리오',
