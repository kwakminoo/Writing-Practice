...
async function uploadOneSentenceNovel() {
  console.log('=== 한 문장 소설 데이터 업로드 ===');
  
  // 1. CSV 데이터 읽기
  console.log('\n1. CSV 파일에서 데이터 읽는 중...');
  const csvData = getCsvData();
  console.log(`총 ${csvData.length}개의 한 문장 소설 데이터를 찾았습니다.`);
  ...
  try {
    ...
    console.log('한 문장 소설 데이터 업로드 완료!');
