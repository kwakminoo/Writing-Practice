...
async function uploadRemainingPoetryData() {
  console.log('=== 남은 시 데이터 업로드 시작 ===\n');
  
  const files = [
    '__________________.csv', // 감각분리 시 파일
  ...
  console.log('=== 남은 시 데이터 업로드 완료 ===');
}

uploadRemainingPoetryData().catch(console.error); 